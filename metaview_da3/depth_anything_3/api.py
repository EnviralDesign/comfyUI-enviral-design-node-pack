...
# NOTE (MetaView vendoring): the export subpackage (glb/gs/npz/colmap/feat_vis)
# pulls in moviepy and other heavy deps not present in the ComfyUI venv and is
# never used by the conditioning path. It is imported lazily inside
# _export_results so importing this module never requires those deps.
...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def _export_results(
        ...
        from depth_anything_3.utils.export import export  # lazy: heavy deps
        start_time = time.time()
